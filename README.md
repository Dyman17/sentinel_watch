...
· **Презентация проекта (Pitch Deck)** — [ссылка на Google Drive]  
· **Основная документация (Google Docs)** — [ссылка на Google Docs]

---

## 🎥 Видеоматериалы

· **Демонстрация работы системы** — [ссылка на видео]
